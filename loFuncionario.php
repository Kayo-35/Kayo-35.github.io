    ...
    <body>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbar">
                        <div class="navbar-nav">
                            ...
                            <a class="nav-link active link-success" href="loFuncionario.php">Funcionario</a>
                        </div>
                    </div>
                </div>
            </nav>
        ...
        <section class="container mt-5">
            <div class="row d-flex justify-content-center">
                <div class="col-md-4">
                    <img class="img-fluid img-thumbnail" src="img/loginFuncionario.jpg">
                </div>
                <form method="post" class="col-md-8">
                    <h3 class="mt-5">Acesso para Funcionários</h3>
                    <p>Caso seja um gerente acesse a página especifica para login dos mesmos!</p>
                    ...
                    <div class="row d-flex justify-content-center">
                        ...
                        <button type="submit" class="btn btn-success col-md-5 ms-2" data-bs-toogle="modal" data-bs-target="#modal">Submeter</button>
                    </div>
                    <?php if ($_POST) {
                        ...
                        if ($res->num_rows > 0) {
                            ...
                            echo '
                                    <div class="container mt-5 text-center text-light bg-danger">
                                        <p>ERRO AO ACESSAR! VERIFIQUE OS DADOS E TENTE NOVAMENTE!</p>
                                    </div>
                                ';
                        }
                    } ?>
