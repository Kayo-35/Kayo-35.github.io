                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbar">
                        <div class="navbar-nav">
                            <a class="nav-link link-success active" href="loFuncionario.php">Funcionario</a>
                        </div>
                    </div>
                </div>
            </nav>
            ...
            <div class="row d-flex justify-content-center">
                <div class="card bg-dark text-light col-md-5 me-2">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Verifique seu historico de pontos em nossa empresa!</p>
                ...
                <div class="card bg-dark text-light col-md-5 ms-2">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Bata seu ponto!</p>
                        <a class="btn btn-primary" type="button" href="gFunc/baterPonto.php">Bater Ponto</a>
                    </div>
                </div>
            </div>
        </section>
